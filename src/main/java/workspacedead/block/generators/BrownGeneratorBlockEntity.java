...
public class BrownGeneratorBlockEntity extends BaseGeneratorBlockEntity {// implements IInventoryHolder {
    ...
    public BrownGeneratorBlockEntity(BlockPos position, BlockState state) {
        super(MyBlockEntities.BROWN_GENERATOR_ENTITY.get(), position, state);
    }
