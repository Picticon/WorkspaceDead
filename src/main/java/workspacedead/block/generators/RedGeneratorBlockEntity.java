...
public class RedGeneratorBlockEntity extends BaseGeneratorBlockEntity {// implements IInventoryHolder {
    ...
    public RedGeneratorBlockEntity(BlockPos position, BlockState state) {
        super(MyBlockEntities.RED_GENERATOR_ENTITY.get(), position, state);
    }
