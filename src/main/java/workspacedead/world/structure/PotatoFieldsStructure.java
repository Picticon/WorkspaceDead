...
public class PotatoFieldsStructure extends StructureFeature<JigsawConfiguration> {
    ...
    public PotatoFieldsStructure() {
        // Create the pieces layout of the structure and give it to the game
        super(CODEC, PotatoFieldsStructure::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        if (!PotatoFieldsStructure.isFeatureChunk(context)) {
        ...
        if(structurePiecesGenerator.isPresent()) {
            ...
            WorkspaceDead.LOGGER.debug("Structure at {}", blockpos);
        }
