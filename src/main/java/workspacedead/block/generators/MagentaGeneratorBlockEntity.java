...
public class MagentaGeneratorBlockEntity extends BaseGeneratorBlockEntity {// implements IInventoryHolder {
    ...
    public MagentaGeneratorBlockEntity(BlockPos position, BlockState state) {
        super(MyBlockEntities.MAGENTA_GENERATOR_ENTITY.get(), position, state);
    }
