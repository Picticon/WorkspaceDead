...
public class GreenGeneratorBlockEntity extends BaseGeneratorBlockEntity {// implements IInventoryHolder {
    ...
    public GreenGeneratorBlockEntity(BlockPos position, BlockState state) {
        super(MyBlockEntities.GREEN_GENERATOR_ENTITY.get(), position, state);
    }
