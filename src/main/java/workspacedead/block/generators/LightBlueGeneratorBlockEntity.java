...
public class LightBlueGeneratorBlockEntity extends BaseGeneratorBlockEntity {// implements IInventoryHolder {
    ...
    public LightBlueGeneratorBlockEntity(BlockPos position, BlockState state) {
        super(MyBlockEntities.LIGHTBLUE_GENERATOR_ENTITY.get(), position, state);
    }
