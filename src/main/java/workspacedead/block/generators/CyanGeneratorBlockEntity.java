...
public class CyanGeneratorBlockEntity extends BaseGeneratorBlockEntity {// implements IInventoryHolder {
    ...
    public CyanGeneratorBlockEntity(BlockPos position, BlockState state) {
        super(MyBlockEntities.CYAN_GENERATOR_ENTITY.get(), position, state);
    }
