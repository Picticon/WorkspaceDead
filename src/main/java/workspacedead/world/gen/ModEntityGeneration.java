// package workspacedead.world.gen;
...
//         addEntityToAllOverworldBiomes(event, ModEntityTypes.SKELETONCHICKEN.get(), 40, 2, 4);
//         addEntityToAllOverworldBiomes(event, ModEntityTypes.SKELETONCOW.get(), 40, 2, 4);
//         addEntityToAllOverworldBiomes(event, ModEntityTypes.SKELETONSHEEP.get(), 40, 2, 4);
//         addEntityToAllOverworldBiomes(event, ModEntityTypes.SKELETONPIG.get(), 40, 2, 4);
//         addEntityToAllOverworldBiomes(event, ModEntityTypes.SKELETONSLIME.get(), 40, 2, 4);
//         addEntityToAllOverworldBiomes(event, ModEntityTypes.SKELETONSPIDER.get(), 40, 2, 4);
//     }
