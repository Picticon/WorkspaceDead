...
public class BasePowergenContainer extends AbstractContainerMenu {

    private BlockEntity blockEntity;
    private Player playerEntity;
    private IItemHandler playerInventory;

    public BasePowergenContainer(int windowId, BlockPos pos, Inventory playerInventory, Player player) {
