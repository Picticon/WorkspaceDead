...
public class WhiteGeneratorBlockEntity extends BaseGeneratorBlockEntity {// implements IInventoryHolder {
    ...
    public WhiteGeneratorBlockEntity(BlockPos position, BlockState state) {
        super(MyBlockEntities.WHITE_GENERATOR_ENTITY.get(), position, state);
    }
