...
public class LightGrayGeneratorBlockEntity extends BaseGeneratorBlockEntity {// implements IInventoryHolder {
    ...
    public LightGrayGeneratorBlockEntity(BlockPos position, BlockState state) {
        super(MyBlockEntities.LIGHTGRAY_GENERATOR_ENTITY.get(), position, state);
    }
