...
public class BasePowergenScreen extends AbstractContainerScreen<BasePowergenContainer> {

    private final ResourceLocation GUI = new ResourceLocation(WorkspaceDead.MOD_ID, "textures/gui/powergen_gui.png");

    public BasePowergenScreen(BasePowergenContainer container, Inventory inv, Component name) {
