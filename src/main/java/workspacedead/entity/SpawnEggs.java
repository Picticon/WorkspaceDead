...
public class SpawnEggs {
    ...
    public static final RegistryObject<Item> SKELETONCOW_SPAWNEGG = EGGS.register("skeletoncow_spawn_egg",
            () -> new ForgeSpawnEggItem(ModEntityTypes.SKELETONCOW, 0x94898d, 0x3f3635,
