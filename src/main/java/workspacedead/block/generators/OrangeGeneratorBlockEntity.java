...
public class OrangeGeneratorBlockEntity extends BaseGeneratorBlockEntity {// implements IInventoryHolder {
    ...
    public OrangeGeneratorBlockEntity(BlockPos position, BlockState state) {
        super(MyBlockEntities.ORANGE_GENERATOR_ENTITY.get(), position, state);
    }
