...
public class PinkGeneratorBlockEntity extends BaseGeneratorBlockEntity {// implements IInventoryHolder {
    ...
    public PinkGeneratorBlockEntity(BlockPos position, BlockState state) {
        super(MyBlockEntities.PINK_GENERATOR_ENTITY.get(), position, state);
    }
