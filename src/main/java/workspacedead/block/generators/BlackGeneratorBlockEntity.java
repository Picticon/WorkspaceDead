...
public class BlackGeneratorBlockEntity extends BaseGeneratorBlockEntity {// implements IInventoryHolder {
    ...
    public BlackGeneratorBlockEntity(BlockPos position, BlockState state) {
        super(MyBlockEntities.BLACK_GENERATOR_ENTITY.get(), position, state);
    }
