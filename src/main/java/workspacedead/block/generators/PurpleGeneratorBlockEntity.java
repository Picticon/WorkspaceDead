...
public class PurpleGeneratorBlockEntity extends BaseGeneratorBlockEntity {// implements IInventoryHolder {
    ...
    public PurpleGeneratorBlockEntity(BlockPos position, BlockState state) {
        super(MyBlockEntities.PURPLE_GENERATOR_ENTITY.get(), position, state);
    }
