...
public class MySounds {
    ...
    public static RegistryObject<SoundEvent> POP = registerSoundEvent("pop");
    public static RegistryObject<SoundEvent> PLUNGER = registerSoundEvent("plunger");

    public static RegistryObject<SoundEvent> FULLMETALALCHEMISER_FIRING = registerSoundEvent("fullmetalalchemiser_firing");
    public static RegistryObject<SoundEvent> FULLMETALALCHEMISER_FIRING_ALT = registerSoundEvent("fullmetalalchemiser_firing_alt");
