...
public class BlueGeneratorBlockEntity extends BaseGeneratorBlockEntity {// implements IInventoryHolder {
    ...
    public BlueGeneratorBlockEntity(BlockPos position, BlockState state) {
        super(MyBlockEntities.BLUE_GENERATOR_ENTITY.get(), position, state);
    }
