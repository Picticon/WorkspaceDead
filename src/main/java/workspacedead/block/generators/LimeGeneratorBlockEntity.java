...
public class LimeGeneratorBlockEntity extends BaseGeneratorBlockEntity {// implements IInventoryHolder {
    ...
    public LimeGeneratorBlockEntity(BlockPos position, BlockState state) {
        super(MyBlockEntities.LIME_GENERATOR_ENTITY.get(), position, state);
    }
